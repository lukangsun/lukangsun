...
\begin{document}
	...
	\begin{array}{l}
		F=\frac{1}{n} \sum_{i=1}^{n} f_{i}, \quad \pi \sim e^{-F .} \\
		f_{n}=\frac{1}{n_{0}} \sum_{i \in I} f_{i}, \# I=n_{0}, \quad \sigma_{n} \sim e^{-f_{n}} . \\
		\phi_{t}(x)=\left(I-t P_{\mu_{n}} \nabla \log \left(\frac{\mu_{n}}{\sigma_{n}}\right)\right) (x), \quad \mu_{t}=\left(\phi_{t}\right)_{\#} \mu_{n} \\
	...
	$$\begin{aligned}
		\phi(\gamma)\leq \phi(0)+\gamma <S_{\mu_n}\nabla\log\(\frac{\mu_n}{\pi},S_{mu_n}\nabla\log\(\frac{\mu_n}{\sigma_n}\)>_H+
		\frac{C\cdot \gamma^2}{2}<S_{\mu_n}\nabla\log\(\frac{\mu_n}{\sigma_n},S_{\mu_n}\nabla\log\(\frac{
			\mu_n}{\sigma_n}\)>_H
		\end{aligned}$$
   ...
   $$
  \textbf{E}\left\[\left\|S_{\mu_{n+1}}\nabla \log \left(\frac{\mu_{n+1}}{\pi}\right)-S_{\mu_{n+1}}\nabla \log \left(\frac{\mu_{n+1}}{\sigma_{n+1}}\right)\right\|_{H}^{2}\right\] $$
