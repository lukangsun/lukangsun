...
here $\gamma\leq \frac{\alpha-1}{\alpha B \left\|g^{\prime}_n\right\|_{\cH}}$.
...
\end{equation}
 ...
 by choosing \begin{equation}
 	\gamma\leq \frac{1}{\alpha^2+M+B\left(2L+\int|\nabla\log\left(\pi\right)(x)|+|\nabla\log\left(\sigma_{I^{\prime}}\right)(x)|d\mu_n(x)\right)\sqrt{\frac{C}{p}}},
 \end{equation} the last condition holds. 
  Then
  \begin{equation}
