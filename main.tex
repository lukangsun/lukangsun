...
\begin{enumerate}
  ...
  \item Did you describe the limitations of your work?
    \answerYes{} : Our main limitation is that we study SVGD \textit{in the population limit}, this is explicitly stated in the abstract. 
...
\asnote{I rewrote Lukang's proof and it seems to work.}
...
Therefore, the set $S$ is compact. Since $F$ is continuous, $F$ admits a minimizer $x_\star$ on the compact set $\{x \in \sX : F(x) \leq 1\}$, and $x_\star$ is a stationary point (the point $x_\star$ is actually a global minimizer of $F$).
