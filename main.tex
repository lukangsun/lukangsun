...
\begin{assumplist}
	...
	\item 	\label{ass:dist} The kernel $k$ is distantly dissipative: 
...
\section{General convergence: IMQ kernel}
...
Therefore, if 
\begin{equation}
    \gamma = (\alpha-1)\left(\alpha B^2 \left(1 + 2M\lambda \sqrt{F(x_\star) + \frac{d}{2}\log \left(\frac{M}{2\pi}\right)} +  \sqrt{Md}\right)\right)^{-1},
\end{equation}
we have
